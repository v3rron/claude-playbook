---
name: mem
description: Manage structured project knowledge base in .context/knowledge/ for durable cross-session knowledge capture. Use for setting up or updating project knowledge bases.
---
...
Structured project knowledge for cross-session persistence. Each file covers a topic/domain.

| File | Topic | Key Entities | Last Updated |
|------|-------|-------------|-------------|
```

3. Report the path created and suggest initial topics based on what is visible in the repo (CLAUDE.md, README, directory structure)
...
- Coverage gaps (areas of the project not yet captured)
...
- People, roles, org structure relevant to the project

## What Does NOT Belong

- Operational items (todos, plans, schedules) — those go in `.context/plans/` or `.context/work/`
...
- User preferences or personal context (that's what auto-memory is for)
