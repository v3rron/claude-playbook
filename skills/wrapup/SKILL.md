...
End-of-session sweep that detects loose ends and routes to follow-up actions before you close the conversation.
...
- Suggest: review, merge, or close stale ones

### Check 5: Session Learnings

Scan the conversation for signals that learnings should be captured:
...
If any signals found: summarize what should be captured
