...
**Invoke First section:** If the remaining work maps to an existing skill (e.g., `/spike` for research, `/pr` for shipping), include an "Invoke First" section. Omit if no skill applies.
